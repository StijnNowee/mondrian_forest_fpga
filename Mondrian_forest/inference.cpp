...
void run_inference(hls::stream<int> &processTreeStream, hls::stream<input_vector> &inferenceStream, const Node_sml trees[TREES_PER_BANK][MAX_PAGES_PER_TREE*MAX_NODES_PER_PAGE], hls::stream<ClassDistribution> inferenceOutputstreams[TREES_PER_BANK]);
...
void inference(hls::stream<input_vector> &inferenceInputStream, hls::stream<Result> &resultOutputStream, const Page *pagePool)
{
    #pragma HLS DATAFLOW
    ...
    hls_thread_local hls::task t2(run_inference, processTreeStream, inferenceInputStream, trees, inferenceOutputstreams);
