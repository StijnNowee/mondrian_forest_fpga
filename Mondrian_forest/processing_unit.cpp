...
void inference_control_unit(hls::stream<input_vector> splitFeatureStream[TREES_PER_BANK], hls::stream<ClassDistribution> voterOutputStream[TREES_PER_BANK], const int &size, const Page *pageBank);
